...
class HniFormWidget extends StatefulWidget {
  final HniCustomerModel? data;
  const HniFormWidget({super.key, required this.data});

  @override
  State<HniFormWidget> createState() => _HniFormWidgetState();
}

class _HniFormWidgetState extends State<HniFormWidget> {
                ...
                title: Column(
                  ...
                  children: [
                    ...
                    if (widget.data!.questions[index].options.isNotEmpty) ...[
                      if (widget.data!.questions[index].options[0].questions != null) ...[
                        OptionWidget(
...
class OptionWidget extends StatefulWidget {
  final List<OptionQuestions>? options;
